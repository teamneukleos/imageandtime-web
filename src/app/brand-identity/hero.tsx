...
export default function Hero() {
  return (
    <section 
      ...
      style={{ backgroundImage: "url('/awarri/awarri-bg.png')" }}
    >
      {/* Dark Overlay */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center mt-20 md:mt-0">
        ...
        >
          ...
          >
            Great brands don’t start with logos.
            <br />
            <span className="text-gray-300">They start with how people feel when they encounter them.</span>
          </motion.h1>
