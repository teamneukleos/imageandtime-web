  ...
  return (
    <section className="w-full bg-[#0D0D0D] pt-[-16px] pb-12 px-6 md:px-12">
      ...
      <div className="max-w-5xl mx-auto mb-20">
        <div className="max-w-4xl space-y-6">
          ...
          <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
            ...
            comfort. Our brand exudes confidence, poise, and elegance, ensuring
            our audience thinks of us first whenever they seek safe and
            comfortable travel.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-20">
        <div className="max-w-4xl space-y-6">
          ...
          <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
            ...
            brand assets, creating compelling collaterals, and ensuring alignment
      ...
      <div className="max-w-5xl mx-auto mb-20">
        <div className="max-w-4xl space-y-6">
          ...
          <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
            ...
            by being in control, while also trailblazing with innovation and
            discovery in our service delivery.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-16">
        <div className="max-w-4xl space-y-6">
          ...
          <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
            ...
            impact, with strict rules for clear space, minimum size, and correct
            usage to maintain consistency across applications.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-28 flex justify-center">
        <img
          src="/one-alpha/logo-journey1.png"
      ...
      <div className="max-w-5xl mx-auto mb-16">
        <div className="max-w-4xl space-y-6">
          ...
          <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
            ...
            unique colour codes such as Spanish Orange, Azure Blue, Sky Blue, and
            Yellow Orange.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-16">
        <div className="max-w-4xl space-y-6">
          ...
          <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
            ...
            as background elements to bring visual interest to compositions.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        <div className="max-w-4xl space-y-6">
          ...
          <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
            ...
            to minimum size and clear space rules to ensure legibility and impact.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-16">
        <div className="max-w-4xl space-y-6">
          ...
          <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
            ...
            merchandise, vehicle livery, and signage. Each extension reinforces
            the brand’s premium and consistent image.
          </p>
        </div>
      </div>
