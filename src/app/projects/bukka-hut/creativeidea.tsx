  ...
  return (
    <section className="w-full bg-[#111111] pt-[-16px] pb-12 px-6 md:px-12">
      ...
      <div className="max-w-6xl mx-auto mb-28 flex flex-col sm:flex-row justify-center items-center gap-8">
        <img
          src="/bukka-hut/final-logo-2.png"
          alt="Final logo"
          className="w-full max-w-md h-auto object-contain"
        />
        <img
          src="/bukka-hut/final-logo2.png"
          alt="Logo animation"
          className="w-full max-w-md h-auto object-contain"
        />
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-28 space-y-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <img
            src="/bukka-hut/uniform-1.jpg"
            alt="Uniform sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/uniform-2.jpg"
            alt="Uniform sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/uniform-3.png"
            alt="Uniform sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/uniform-4.png"
            alt="Uniform sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/uniform-5.png"
            alt="Uniform sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/uniform-6.jpg"
            alt="Uniform sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/uniform-7.png"
            alt="Uniform sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/uniform-8.png"
            alt="Uniform sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/jacket-1.jpg"
            alt="Uniform sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/cap-1.png"
            alt="Chef cap sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/cap-2.png"
            alt="Chef cap sample"
            className="w-full h-auto object-cover"
          />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <img
            src="/bukka-hut/cup.png"
            alt="Cup sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/dispatch.png"
            alt="Dispatch sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/bus.png"
            alt="Bus branding sample"
            className="w-full h-auto object-cover"
          />
          <img
            src="/bukka-hut/storefront.png"
            alt="Storefront sample"
            className="w-full h-auto object-cover"
          />
        </div>
      </div>
