      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="max-w-4xl space-y-6 mb-20 mt-[-50px]">
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            benefits and reasons to believe — the bank can articulate a powerful
            essence that connects directly with people’s lives. This essence
            defines Union Bank’s role and personality, positioning it not just as
            a financial institution but as a trusted partner that reflects the
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            the approach emphasizes authenticity, trust, and innovation, while
            driving user acquisition and loyalty. The result is a brand that
            evolves with consumer expectations, reinforces its heritage, and
            builds stronger emotional bonds — ensuring Union Bank remains a
            modern, dependable choice for generations to come.
          </p>
        </div>
