  ...
  return (
    <section className="w-full bg-[#0D0D0D] py-14 md:py-28 px-6 md:px-12">
      ...
      <div className="max-w-xl mx-auto mb-24 grid grid-cols-1 md:grid-cols-2 gap-6">
        <img
          src="/awarri/sketch-1.png"
          alt="Logo sketch exploration"
          className="w-full h-auto object-cover"
        />
        <img
          src="/awarri/sketch-2.png"
          alt="Logo sketch refinement"
          className="w-full h-auto object-cover"
        />
      </div>

      {/* LOGO JOURNEY / PROCESS */}
      <div className="max-w-6xl mx-auto mb-28 flex justify-center">
        <img
          src="/awarri/logo-journey.png"
          alt="Awarri logo design journey"
      ...
      <div className="max-w-4xl mx-auto mt-16 flex justify-center">
        <img
          src="/awarri/pattern.png"
          alt="Awarri visual pattern system"
