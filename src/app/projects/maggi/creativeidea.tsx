        ...
        <div className="max-w-4xl space-y-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
              ...
              Amapiano, Highlife, and Afropop with step-by-step recipes, 
              we transformed meals into musical performances. Chopping 
              became percussion. Stirring became rhythm.
            </p>
            <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
