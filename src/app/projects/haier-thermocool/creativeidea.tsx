...
export default function CreativeIdea() {
  return (
    <section className="w-full bg-[#0D0D0D] py-14 md:py-28 px-6 md:px-12">
      ...
      {/* SECTION TEXT - ALIGNED WITH VIDEO FRAME */}
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-28">
        ...
        <img src="/haier-thermocool/img4.jpg" alt="Creative Idea Image" className="w-full object-cover" />
        <img src="/haier-thermocool/img5.jpg" alt="Creative Idea Image" className="w-full object-cover" />
        <img src="/haier-thermocool/img6.jpg" alt="Creative Idea Image" className="w-full object-cover" />
      </div>
